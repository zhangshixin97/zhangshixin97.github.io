  ...
  capabilities: {
    ...
    "ai-video": {
      ...
      paragraphs: [
        ...
        "我的做法是把视频生产拆成可复用的模块：提前预设好脚本模板、画面风格和卖点库，AI 负责写脚本，数字分身负责出镜，门店实景素材负责真实感。只要你有想法、有创意，每个人都能做出自己门店的专属视频——客房售卖、餐厅推广、二销产品讲解，一个人就能撑起一个账号的更新。我自己也开源了相关的文旅宣传片 Skill，免费给大家使用。",
