...
export const skillsConfig: SkillsConfig = {
  ...
  title: "世鑫 Skill 实战库",
  subtitle:
    "我把这几年门店运营沉淀的自研 Skill 和日常在用的开源好工具，按公众号、小红书、短视频与达人、民宿经营、办公演示五条打法线整理成套——全部免费，带「下载」的直接打包带走，其余加微信领取。收录的开源作品均已署名原作者。",
  groups: [
    {
      name: "世鑫实战打法库",
      note: "自研 + 开源收录 · 按打法成套使用",
      categories: [
        {
          name: "公众号运营打法",
          items: [
            ...
            },
            {
              title: "公众号标题策略师",
              tag: "爆款标题",
              desc: "蒸馏 645 篇爆款文章的三层起标题法，告别流量焦虑。",
            ...
            },
            {
              title: "公众号排版设计系统",
              tag: "排版引擎",
              desc: "主题组件库排版引擎，Markdown 一键转公众号 HTML。",
              hue: "linear-gradient(135deg,#0f766e,#5eead4)",
              download: "/skills/gzh-design-skill.zip",
              doc: "/skill/gzh-design-skill",
              author: "甲木（isjiamu）创作",
            },
            {
              title: "公众号文章一键发布",
              tag: "私域运营",
              desc: "Markdown 文章直接进公众号草稿箱，排版不丢。",
              hue: "linear-gradient(135deg,#15803d,#86efac)",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              title: "小红书起号十件套",
              tag: "起号全链路",
              desc: "定位、选题、标题、正文、封面、复盘，10 个 Skill 一条龙。",
              hue: "linear-gradient(135deg,#e11d48,#fda4af)",
              download: "/skills/space-xhs-toolkit.zip",
              doc: "/skill/space-xhs-toolkit",
              author: "SpaceZephyr 创作",
            },
            {
              title: "小红书笔记采集",
              tag: "素材采集",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              title: "镜头配方库",
              tag: "剪辑素材",
              desc: "152 张镜头配方卡 + 209 个动效预览，B-roll 直接套用。",
              hue: "linear-gradient(135deg,#7c3aed,#c4b5fd)",
              download: "https://github.com/Vincentwei1021/video-shotcraft",
              doc: "/skill/video-shotcraft",
              author: "Vincentwei1021 创作",
            },
            {
              title: "抖音达人账号深度分析",
              tag: "达人筛选",
              desc: "作品、数据、评论三合一证据链，判断达人能不能合作。",
              hue: "linear-gradient(135deg,#1e40af,#93c5fd)",
              author: "布兰德老白 创作 · 加微信领取",
            },
            {
              title: "酒店文旅内容工作流",
              tag: "内容工作流",
              desc: "把门店空间、服务和周边玩法，整理成能拍能发的内容计划。",
              hue: "linear-gradient(135deg,#0891b2,#67e8f9)",
              download: "/skills/hospitality-content.zip",
              doc: "/skill/hospitality-content",
              author: "OmniBoard 创作",
            },
            {
              title: "网页视频演示",
          ...
          items: [
            {
              title: "糖果风 PPT 生成器",
              tag: "演示制作",
              desc: "马卡龙配色 + 动画效果的 HTML 幻灯片，培训课件直接用。",
              hue: "linear-gradient(135deg,#db2777,#f9a8d4)",
