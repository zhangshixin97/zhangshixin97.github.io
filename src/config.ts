...
export const capabilitiesConfig: CapabilitiesConfig = {
  ...
  title: "AI 如何真正进入门店经营",
  subtitle:
    "不讲概念，只讲已经在门店里跑通的七件事。每个方向都有对应的 Skill、工作流和培训方案。",
  detailHint: "点击查看完整拆解",
  items: [
    {
      title: "AI 知识库搭建",
      ...
      description:
        "用 Obsidian 为个人与企业搭建可检索、可复用的知识库：SOP、话术、政策、案例统一沉淀，让 AI 和团队随取随用。",
      points: ["个人与企业双场景", "Obsidian 结构化沉淀", "AI 随时调用取料"],
    ...
    },
    {
      ...
      description:
        "自动处理 OTA 渠道与私域的客人咨询，24 小时即时响应、口径一致，复杂问题无缝转人工。",
      points: ["24h 即时响应", "标准化服务输出", "降低客服成本"],
    ...
    },
    {
      title: "AI 视频拍摄",
      slug: "ai-video",
      english: "AI Content Studio",
      description:
        "用 AI 辅助完成选题、脚本、画面与剪辑，让民宿主低成本稳定产出抖音、小红书内容。",
      points: ["脚本一键生成", "内容周更日常化", "抓住平台红利"],
...
export const capabilityDetailConfig: CapabilityDetailConfig = {
  ...
  capabilities: {
    "knowledge-base": {
      ...
      paragraphs: [
        "【专业解释】以 Obsidian 为核心的结构化知识管理体系。将分散的 SOP、话术、房价政策、培训资料、经营案例统一沉淀为双向链接的知识网络，并作为检索增强（RAG）语料接入 AI 工作流——智能回复、新人培训、内容生产全部从同一知识库取料，保证口径一致、持续迭代。",
        ...
        "我用 Obsidian 为个人与企业搭建知识库：按业务结构组织 SOP、服务话术、房价与退改政策、培训资料、经营案例，用双向链接把知识串成网络，再接入 AI 工作流——智能回复从这里调取标准口径，培训从这里生成教材，内容创作从这里取素材。个人用它管理自己的方法论，企业用它让整个团队站在同一套知识上工作。",
    ...
    "ai-reply": {
      title: "AI 智能回复",
      subtitle: "24 小时在线的第一响应者。",
      paragraphs: [
        "【专业解释】基于大语言模型的智能客服系统。将门店知识库（房价、房态、退改政策、入住须知等）向量化检索并加以口径约束，实现 OTA 渠道与私域咨询的自动应答；复杂问题按规则无缝转人工，保证响应时效与回答一致性。",
        "【大白话】客人半夜问「能不能带宠物」「几点能入住」，AI 几秒钟就给出标准答案，口径跟你店里最熟练的前台一模一样。八成以上的咨询它直接接住，搞不定的再叫人——一个询单都不漏。",
        "客人咨询的响应速度，直接决定转化率。携程、美团上来的询单，晚回五分钟，客人可能已经在别家下单；深夜和清晨的咨询，更是大量流失在无人值守的时间段里。而养着一支能三班倒的客服团队，对绝大多数酒店民宿来说并不现实。",
        "AI 智能回复解决的正是这个矛盾：自动处理 OTA 渠道与私域微信里的客人咨询——房价、房态、退改政策、周边交通、入住须知，这些占咨询量八成以上的标准问题，AI 都能在几秒内给出准确、口径一致的回答，复杂问题再无缝转给人工。",
        "落地后的价值非常直接：24 小时即时响应，不再漏掉任何一个时间段的询单；标准化服务输出，新员工也能立刻拥有老员工的话术水平；降低客服人力成本，把人力释放到真正需要温度服务的环节。响应更快，转化自然更高。",
      ],
    },
    "ai-review": {
      title: "AI 智能点评",
    ...
    "ai-video": {
      title: "AI 视频拍摄",
      subtitle: "让民宿主也能低成本做好内容。",
      paragraphs: [
        "【专业解释】面向酒旅场景的 AIGC 内容生产工作流。整合选题策划、脚本生成、画面生成与剪辑包装四个环节，以门店真实素材为输入，批量产出符合抖音、小红书平台调性的短视频内容，显著降低内容生产的边际成本。",
        "【大白话】不用写脚本、不用学剪辑：把店里的照片和故事丢给 AI，它帮你策划选题、写脚本、出画面。民宿主一个人，也能做到周更甚至日更。",
        "抖音、小红书已经是民宿获客的重要入口，但内容生产对大多数民宿主来说门槛太高：不会写脚本、不懂拍摄剪辑、请团队又太贵。很多位置极好、体验极佳的民宿，就因为「不会表达」而淹没在信息流里。",
        "AI 视频拍摄赋能，就是把内容生产的门槛打下来：用 AI 辅助完成选题策划、脚本撰写、画面生成与剪辑包装，民宿主只需要提供真实素材和经营故事，就能稳定产出符合平台调性的短视频内容。我自己也开源了相关的文旅宣传片 Skill，免费给大家使用。",
        "这一方向的核心价值：大幅降低内容生产成本，让「周更甚至日更」从奢侈品变成日常；提升抖音、小红书的内容产出效率，抓住平台流量红利；增强品牌曝光，让好民宿被更多人看见。内容能力，正在成为民宿的第二种房源竞争力。",
      ],
    },
    "ai-ads": {
      title: "AI 智能投放",
